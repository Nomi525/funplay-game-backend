...
export interface CheckUserEmailRequestDto {
  email: string;
  type: string;
  registerType: string;
}

export interface SingupFromEmailPasswordRequestDto {
  fullName: string;
  password: string;
  email: string;
  type: string;
...
export interface UserSignUpSignInOtpResponseDto {
  // readonly id: string;
  readonly fullName: string;
  readonly email: string;
  readonly userName: string;
...
export interface VerifyUserOtpRequestDto {
  userId: string;
  otp: string;
  type: string;
  email: string;
...
export interface ConnectToWalletUserRequestDto {
  email: string;
  currency: string;
  referralByCode?: string;
  password: string;
...
export interface CheckWalletAddressUserRequestDto {
  email: string;
  walletAddress: string;
  walletType: userWalletTypeEnum.WEB3MODEL | userWalletTypeEnum.MAGIC;
}

export interface SingInWalletAddressUserRequestDto {
  // email: string;
  walletAddress: string;
  currency: string;
  referralByCode: string;
...
export interface VerifyForgotOtpUserRequestDto {
  userId: string;
  otp: string;
  email: string;
  mobileNumber: string;
